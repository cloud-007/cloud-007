...
- Requirements into system design, deployment and monitoring, production
  debugging, interviewing candidates, and mentoring the juniors who came after.
...
Handle `cloud_007` on
[Codeforces](https://codeforces.com/profile/cloud_007) ·
[CodeChef](https://www.codechef.com/users/cloud_007) ·
[LightOJ](https://lightoj.com/user/cloud_007) ·
[Toph](https://toph.co/u/cloud_007) ·
[Vjudge](https://vjudge.net/user/cloud_007)

### Judging, teaching, organizing

Judge at the **NEUB ICT Fest hackathon 2025**. Judge and problem setter for
**LU IUJPC: Sylhet Division 2024**, the **Intra IEEE Programming Contest**, and
two IEEE CS chapter contests. Taught **CV building and interview preparation**
at CPS Academy.
...
`Python` `Django` `FastAPI` `PostgreSQL` `Redis` `Celery` · `Flutter` `Dart` ·
`Next.js` `React` `TypeScript` `Tailwind` · `Docker` `GCP` `CI/CD`
`Prometheus` `Grafana` · `Claude Code` `Cursor`

---

*The only difference between the success you see and where I stand today is
time. Just keep trying to become better every day.*
